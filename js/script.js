console.log("This is Javascript code for this project.")
...
async function getSongs(folder) {
    ...
    for (const song of songs) {
        songUL.innerHTML = songUL.innerHTML + `<li><img width="34" src="img/music.svg" class="invert" alt="">
                            <div class="info">
        ...
        if(e.href.includes("/songs")  && !e.href.includes(".htaccess")){
            ...
            <div class="play">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"
                    color="#000000" fill="#000" style="position: relative; top: -1px;">
                    <path
